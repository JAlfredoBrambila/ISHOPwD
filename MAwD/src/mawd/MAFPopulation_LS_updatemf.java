 ...
 * @author MAGM
 */
public class MAFPopulation_LS_updatemf {
    ...
    public int ctm;
    public int[][] ME;    
    public MAFPopulation_LS_updatemf(String arc) {
        this.archivo = arc;
    }
...
public void MF(int[][] mf)
{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        double besttime=0;
        double timelimit=0.007864521;
        Scanner teclado = new Scanner(System.in);
        MAFPopulation_LS_updatemf obj=new MAFPopulation_LS_updatemf("10n20m.txt");
