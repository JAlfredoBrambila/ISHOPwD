...
public class MAChangemuta {
    ...
    public double pc=0.60,pm=0.01,er=0.05,nc=0.10,bestcost,pmu=0.05;
    ...
    public MAChangemuta(String arc) {
        this.archivo = arc;
    }
...
//mutacion Uniforme
//**********************************************************************
public int[] FBU(int[] Xn,double cst)
{
    Xc = Xn;
    oldTotalCost=cst;
    double NewCost=0,alear;
    int iprima=0;
    for(int i=0;i<N;i++)
    {
        for(int j=0;j<M;j++)
...
public void resetpopulation(int[] bestilocal)
{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        double besttime=0;
        double timelimit=30.58207739;
        Scanner teclado = new Scanner(System.in);
        MAChangemuta obj=new MAChangemuta("50n240m_30.txt");
